...
<head>
	...
	<link rel="stylesheet" href="css/style_segretaria.css">
...
<body>
	...
	<div class="header clearfix" >
		...
		<ul class="header__menu animate">
			...
			<li class="header__menu__item"><a href="inser_gara.php">Inserire Gara</a></li>		
			<div class="dropdown">
			  <button class="dropbtn">Giudice</button>
			  <div class="dropdown-content">
				<a href="registra_giudice.php">Registra giudice</a>
				<a href="iscrivi_giudice.php">Iscrivi giudice</a></li>	
			  </div>
			</div>			
			<div class="dropdown">
			  <button class="dropbtn">Visualizza</button>
			  <div class="dropdown-content">
				<a href="visual_candidati.php">Candidati</a>
				<a href="visual_gare.php">Gare</a>
				<a href="visual_giudicegare.php">Giudici iscritti</a>
				<a href="visual_votazioni.php">Votazioni</a>
			  </div>
			</div>
			<div class="dropdown">
			  <button class="dropbtn">Elimina</button>
			  <div class="dropdown-content">
				<a href="elimina_candidati.php">Candidati</a>
				<a href="elimina_gare.php">Gare</a>
			  </div>
			</div>
		</ul>
	</div>
	...
	<section class="cover">
		...
		<div class="cover__caption">
			<div class="cover__caption__copy">
					...
					$sql = "SELECT nome FROM segretaria WHERE username='$user'" ;
