	...
	if ($conn->connect_error) {
		...
		if ($result->num_rows > 0) {
			while($row = $result->fetch_assoc()) {
									...
									echo "<tr>";
									echo "<form action='iscrivi_cane.php?msg=".$row['codGara']."&ms=".$row['codRazza']."' method='post'  onSubmit='return avviso()'>  ";
					...
					echo "<h2 style='text-align:center;'>Non ci sono gare</h2>";
		}
