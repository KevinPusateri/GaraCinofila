...
<head>
	...
	<link rel="stylesheet" href="css/styleproprietario.css">
...
<body>
	...
	<div class="header clearfix" >
		...
		<ul class="header__menu animate">
			...
			<li class="header__menu__item"><a href="eventi.php">Eventi</a></li>
			<div class="dropdown">
			  <button class="dropbtn">Visualizza</button>
			  <div class="dropdown-content">
				<a href="visual_candIscritti.php">Candidati iscritti</a>
				<a href="visual_votcand.php">Votazioni</a>
			  </div>
			</div>
	...
	<section class="cover">
		...
		<div class="cover__caption">
			<div class="cover__caption__copy">
					...
					$sql = "SELECT nome FROM proprietario WHERE username='$user'" ;
